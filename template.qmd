...
::: {style="position: absolute; right: 0px; top: 0px; height: 450px; width: 300px; border:0px solid #D9D9D9 ;background-color: #ffffff; padding: 0px; padding-left: 0px; box-shadow: 0px 0px 0px 0px #85929e; border-radius: 5px;"}
...
ggplot(aes(x = gender, y = ps, fill = gender)) +
  ...
  coord_flip() +
    ...
    labs(title = "Propensity Scores by Gender")


```
:::

::: {style="position: absolute; right: 300px; top: 0px; height: 450px; width: 300px; border:0px solid #D9D9D9 ;background-color: #ffffff; padding: 0px; padding-left: 0px; box-shadow: 0px 0px 0px 0px #85929e; border-radius: 5px;"}
